...
namespace mprpc {
PROTOBUF_CONSTEXPR RpcHHeader::RpcHHeader(
...
struct RpcHHeaderDefaultTypeInternal {
  PROTOBUF_CONSTEXPR RpcHHeaderDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~RpcHHeaderDefaultTypeInternal() {}
  union {
    RpcHHeader _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 RpcHHeaderDefaultTypeInternal _RpcHHeader_default_instance_;
}  // namespace mprpc
...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHHeader, _impl_.service_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHHeader, _impl_.method_name_),
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHHeader, _impl_.args_size_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::mprpc::RpcHHeader)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::mprpc::_RpcHHeader_default_instance_._instance,
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\005mprpc\"J\n\nRpcHHeader\022\024"
...
const ::_pbi::DescriptorTable descriptor_table_rpcheader_2eproto = {
    false, false, 108, descriptor_table_protodef_rpcheader_2eproto,
    "rpcheader.proto",
...
class RpcHHeader::_Internal {
 public:
};

RpcHHeader::RpcHHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:mprpc.RpcHHeader)
}
RpcHHeader::RpcHHeader(const RpcHHeader& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  RpcHHeader* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  // @@protoc_insertion_point(copy_constructor:mprpc.RpcHHeader)
}

inline void RpcHHeader::SharedCtor(
...
RpcHHeader::~RpcHHeader() {
  // @@protoc_insertion_point(destructor:mprpc.RpcHHeader)
...
inline void RpcHHeader::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.service_name_.Destroy();
  _impl_.method_name_.Destroy();
}

void RpcHHeader::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void RpcHHeader::Clear() {
// @@protoc_insertion_point(message_clear_start:mprpc.RpcHHeader)
...
const char* RpcHHeader::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* RpcHHeader::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:mprpc.RpcHHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:mprpc.RpcHHeader)
  return target;
}

size_t RpcHHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:mprpc.RpcHHeader)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData RpcHHeader::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    RpcHHeader::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*RpcHHeader::GetClassData() const { return &_class_data_; }


void RpcHHeader::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<RpcHHeader*>(&to_msg);
  auto& from = static_cast<const RpcHHeader&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:mprpc.RpcHHeader)
...
void RpcHHeader::CopyFrom(const RpcHHeader& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:mprpc.RpcHHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool RpcHHeader::IsInitialized() const {
  return true;
}

void RpcHHeader::InternalSwap(RpcHHeader* other) {
  using std::swap;
...
::PROTOBUF_NAMESPACE_ID::Metadata RpcHHeader::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::mprpc::RpcHHeader*
Arena::CreateMaybeMessage< ::mprpc::RpcHHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::mprpc::RpcHHeader >(arena);
}
